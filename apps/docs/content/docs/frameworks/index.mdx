...
<Cards>
  <Card icon={<SiNextdotjs size={20} />} href="/docs/frameworks/nextjs" title="Next.js">
    Client vars work out of the box via NEXT_PUBLIC_*
  </Card>
  <Card icon={<SiVite size={20} />} href="/docs/frameworks/vite" title="Vite / React">
    Needs static gen or vite.config.ts define bridge for client
  </Card>
  <Card icon={<SiSvelte size={20} />} href="/docs/frameworks/sveltekit" title="SvelteKit">
    Server routes work, client needs bridge
  </Card>
  <Card icon={<SiAstro size={20} />} href="/docs/frameworks/astro" title="Astro">
    Server islands work, client islands need static gen
  </Card>
  <Card icon={<SiRemix size={20} />} href="/docs/frameworks/remix" title="Remix">
    Server-only — no client concerns
  </Card>
  <Card icon={<SiExpress size={20} />} href="/docs/frameworks/express" title="Express / Hono / Fastify">
    Pure server, just works
  </Card>
  <Card icon={<SiCloudflare size={20} />} href="/docs/frameworks/cloudflare" title="Cloudflare Workers">
