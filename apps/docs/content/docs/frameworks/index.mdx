...
<Cards>
  <Card icon={<SiNextdotjs size={20} color="#fff" />} href="/docs/frameworks/nextjs" title="Next.js">
  ...
  <Card icon={<SiAstro size={20} color="#bc52ee" />} href="/docs/frameworks/astro" title="Astro">
    Server islands work, client islands need static gen
  </Card>
  <Card icon={<SiRemix size={20} color="#fff" />} href="/docs/frameworks/remix" title="Remix">
    Server-only — no client concerns
  </Card>
  <Card icon={<SiExpress size={20} color="#fff" />} href="/docs/frameworks/express" title="Express / Hono / Fastify">
