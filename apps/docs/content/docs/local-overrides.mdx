...
Local files support the complete [`.vars` file format](/docs/file-format): env blocks, groups, schemas, interpolation, `use` imports, and conditionals. No restrictions.
