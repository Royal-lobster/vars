...
| `.varskey` | Encryption key (locked behind your PIN) | No (gitignored) |
...
vars decrypts secrets in memory (nothing hits disk) and injects them as environment variables into your process. Works with any command:
...
No `.env` file to track down, no 1Password vault to set up, no Doppler invite to send.
...
<Cards>
  <Card href="/docs/file-format" title="File Format">
    Full syntax guide — groups, conditionals, check blocks, interpolation.
  </Card>
  <Card href="/docs/cli" title="CLI Workflow">
    All commands for managing secrets day to day.
  </Card>
  <Card href="/docs/frameworks" title="Framework Guides">
    Next.js, Vite, Astro, and more.
  </Card>
  <Card href="/docs/security" title="Encryption & Security">
    How the crypto works, threat model.
  </Card>
</Cards>
