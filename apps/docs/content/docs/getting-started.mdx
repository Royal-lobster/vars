...
vars also updates your `.gitignore` and installs a pre-commit hook that prevents committing decrypted secrets.
...
- [CLI reference](/docs/cli/setup-auth) — all commands
- [Framework integration](/docs/frameworks) — Next.js, Vite, Astro, and more
