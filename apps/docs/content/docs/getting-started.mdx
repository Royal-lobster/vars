...
If they need different local values (e.g., a different database host), they create a `config.local.vars` — see [Local Overrides](/docs/file-format#local-overrides).
