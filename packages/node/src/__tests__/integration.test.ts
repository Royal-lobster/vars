...
describe("full pipeline integration", () => {
	it("parse → resolve → validate → codegen end-to-end", () => {
		const resolved = resolveUseChain(resolve(fixtureDir, "services/api/vars.vars"), { env: "dev" });
...
SECRET : z.string() {
  dev = "stable-value"
	...
	it("multi-file use chain resolves all variables", () => {
		const resolved = resolveUseChain(resolve(fixtureDir, "services/api/vars.vars"), {
			env: "prod",
		});
