...
export function computeCompletions(ctx: CompletionContext): CompletionItem[] {
  ...
  if (isInsideCheck(ctx.text, ctx.line)) {
    ...
    return [
      ...
      { label: "defined", kind: CompletionItemKind.Function, insertText: "defined($1)", insertTextFormat: 2 as const },
      { label: "matches", kind: CompletionItemKind.Function, insertText: 'matches($1, "$2")', insertTextFormat: 2 as const },
      { label: "starts_with", kind: CompletionItemKind.Function, insertText: 'starts_with($1, "$2")', insertTextFormat: 2 as const },
      { label: "one_of", kind: CompletionItemKind.Function, insertText: "one_of($1, [$2])", insertTextFormat: 2 as const },
      { label: "length", kind: CompletionItemKind.Function, insertText: "length($1)", insertTextFormat: 2 as const },
  ...
  if (prefix.match(/^\s*$/)) {
    return [
      { label: "env", kind: CompletionItemKind.Keyword, insertText: "env($1)", insertTextFormat: 2 as const, detail: "Declare environments" },
      { label: "param", kind: CompletionItemKind.Keyword, insertText: "param $1 : enum($2) = $3", insertTextFormat: 2 as const },
      { label: "use", kind: CompletionItemKind.Keyword, insertText: 'use "$1"', insertTextFormat: 2 as const },
      { label: "group", kind: CompletionItemKind.Keyword, insertText: "group $1 {\n  $2\n}", insertTextFormat: 2 as const },
      { label: "public", kind: CompletionItemKind.Keyword },
      { label: "check", kind: CompletionItemKind.Keyword, insertText: 'check "$1" {\n  $2\n}', insertTextFormat: 2 as const },
    ];
  }
...
function getMetadataCompletions(): CompletionItem[] {
  return [
    { label: "description", kind: CompletionItemKind.Property, insertText: 'description = "$1"', insertTextFormat: 2 as const },
    { label: "owner", kind: CompletionItemKind.Property, insertText: 'owner = "$1"', insertTextFormat: 2 as const },
    { label: "expires", kind: CompletionItemKind.Property, insertText: "expires = $1", insertTextFormat: 2 as const },
    { label: "deprecated", kind: CompletionItemKind.Property, insertText: 'deprecated = "$1"', insertTextFormat: 2 as const },
    { label: "tags", kind: CompletionItemKind.Property, insertText: "tags = [$1]", insertTextFormat: 2 as const },
  ];
}
